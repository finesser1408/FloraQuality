@props(['value', 'description' => null, 'icon', 'iconBg' => '#059669', 'iconColor' => '#ffffff', 'trend' => null, 'trendUp' => null])
    ...
    <div class="flex items-center justify-between">
        ...
        @if($trend !== null)
            <div class="flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full
                ...
                style="{{ $trendUp ? 'background:rgba(5,150,105,0.08)' : 'background:rgba(220,38,38,0.08)' }}">
